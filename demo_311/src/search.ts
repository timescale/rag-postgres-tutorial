// searchDocuments — exposes seven composable retrieval modes over the documents
// table: BM25, vector, hybrid (RRF), ltree, temporal range, geo, JSONB.
//
// Direct port of the tutorial's Step 6h with the bug fixes noted in NOTES.md.
